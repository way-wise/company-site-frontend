          ...
          <div className="lg:col-span-5">
            <div className="mb-4 lg:mb-16">
              ...
              <p className=" md:mr-6 text-sm sm:text-base leading-relaxed text-gray-600 dark:text-white">
                Way Wise Tech is a leading Web and Software Development Company
                in the USA, delivering innovative custom software development
                solutions for businesses worldwide. Our experienced team
                specializes in web application development, mobile app
                development, and enterprise software solutions, helping
                organizations build scalable and high-performance digital
                products. Through modern technologies, cloud engineering
                services, and full-stack development expertise, we empower
                businesses to accelerate growth and achieve successful digital
                transformation with secure, reliable, and results-driven
                software solutions.
              </p>
              <ul className="mt-4 space-y-1">
                <li className="flex items-center gap-2 text-sm sm:text-base text-black dark:text-gray-300">
                  <svg
                  ...
                  <Link
                    ...
                    className="hover:text-primary duration-300 no-underline"
                  >
                ...
                <li className="flex items-start gap-2 text-sm sm:text-base text-black dark:text-gray-300">
                  <svg
                    className="w-4 h-4 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
