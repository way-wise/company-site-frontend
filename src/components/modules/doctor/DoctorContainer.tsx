...
/**
 * Shared width constraint for the /doctor landing page.
 *
...
export const DOCTOR_CONTENT_WIDTH = "max-w-[1420px]";
/** Navbar-only cap — wider than the content sections by design. */
export const DOCTOR_NAV_WIDTH = "max-w-[1530px]";

const DoctorContainer = ({
  children,
  className,
  innerClassName,
  maxWidthClass = DOCTOR_CONTENT_WIDTH,
}: {
   ...
   * (to DOCTOR_NAV_WIDTH); every other section keeps the default.
   */
