import sectionBg from "@/assets/images/doctor/development_team_section_bg.webp";
import midCard from "@/assets/images/doctor/mid_card_img.webp";
import avatar from "@/assets/images/doctor/xs.png";
...
const Card = ({
  ...
  <div className="rounded-xl bg-[#150C2B]/20 p-px">
    <div className={`h-full rounded-xl border border-[#007AFF]/50  p-7 ${className ?? ""}`}>
      {children}
    </div>
  </div>
);
