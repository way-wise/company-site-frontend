    ...
    >
      <DoctorContainer className="py-15 lg:py-28">
        <DoctorSectionHeading
          ...
          heading="What Our Healthcare Clients Say About Working With Us"
