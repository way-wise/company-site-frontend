...
import bannerImage from "@/assets/images/attorney/banner.webp";
    ...
    <section className="relative isolate overflow-hidden bg-black">
      ...
      >
        <div className="max-w-[680px]">
          ...
          >
            Way Wise Tech creates professional websites and secure client
            portals for law firms, helping attorneys attract clients and improve
            efficiency.
          </p>
