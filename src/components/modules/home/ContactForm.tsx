    ...
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 space-y-2">
          ...
          <Input
            ...
            onChange={handleInputChange}
            className={`w-full ${errors.whatsappNumber ? "border-red-500" : ""}`}
            disabled={isSubmitting}
          />
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 space-y-2">
          ...
          >
            <SelectTrigger
              className={`w-full ${errors.serviceRequired ? "border-red-500" : ""}`}
            >
        ...
        <div className="flex-1 space-y-2">
          ...
          >
            <SelectTrigger
              className={`w-full ${errors.projectBudget ? "border-red-500" : ""}`}
            >
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          onChange={handleInputChange}
          rows={8}
          className={`w-full resize-none ${errors.projectDescription ? "border-red-500" : ""}`}
