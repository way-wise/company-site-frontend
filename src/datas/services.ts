...
export const servicesFirstData: ServiceDetail[] = [
  {
    ...
    description:
      ...
      "Build secure, scalable web applications tailored to your business needs with Way Wise Tech's custom web application development services.",
    bgImage: webAppBg,
    url: "/services/web-application",
    icon: webIcon,
    videoImage: webImg,
    detailedTitle:
      "Web Application Services in USA | Website Development Company",
    detailedDescription:
  ...
  },
  {
    ...
    description:
      "Build scalable iOS, Android, and cross-platform apps with Way Wise Tech's mobile application development services.",
    bgImage: mobileAppBg,
    url: "/services/mobile-application",
    icon: mobileIcon,
    videoImage: appImg,
    detailedTitle:
      "Mobile Application Services in USA | App Development Company",
    detailedDescription:
  ...
  },
  {
    ...
    slug: "ai-integration",
    description:
      "Develop AI-powered solutions with Way Wise Tech, from machine learning applications to intelligent systems designed to improve business processes.",
...
export const servicesSecondData: ServiceDetail[] = [
  {
    ...
    description:
      "Create compelling visual experiences with Way Wise Tech's graphic design services for branding, digital products, websites, and marketing.",
  ...
  },
  {
    ...
    description:
      "Grow your online presence with Way Wise Tech's digital marketing services, including SEO, social media, PPC, content marketing, and more.",
  ...
  },
  {
    ...
    description:
      "Build secure, scalable cloud infrastructure with Way Wise Tech's cloud engineering services for reliable and future-ready digital systems.",
    bgImage: cloudEngineeringBg,
    url: "/services/cloud-engineering",
    icon: internetIcon,
    videoImage: cloudImg,
    detailedTitle:
      "Cloud Engineering Services in USA | Cloud Solutions Company",
    detailedDescription:
