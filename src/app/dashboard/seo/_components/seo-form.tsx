...
const PREDEFINED_PAGES = [
  ...
  { slug: "services/web-application", name: "Web Application Services" },
  { slug: "services/mobile-application", name: "Mobile Application Services" },
  { slug: "services/ai-integration", name: "AI/ML Services" },
  { slug: "services/graphics-design", name: "Graphics Design Services" },
  { slug: "services/digital-marketing", name: "Digital Marketing Services" },
  { slug: "services/cloud-engineering", name: "Cloud Engineering Services" },
